...
This document tests all the features implemented in ScripTeX.
...
\textsc{Small Caps}, \underline{underlined text}, \sout{strikethrough text},
and \textcolor{red}{red text} with \textcolor{blue}{blue text}.
...
\subsection{Right-Aligned Content}

\begin{flushright}
This text is right-aligned.

Multiple lines are right-aligned independently.
\end{flushright}
...
This document has tested all major features of ScripTeX including:
\begin{itemize}
